...
//                        Student std = new Student(1, "Hi", "Lo", "Test@test.com", "2", (float) 1.2, false, true, "SE", "ICS", cours);
                    ...
                    TAInterface ta2 = (TAInterface) ta.Login(email, password, usertype);
                    ...
                    if (ta2 == null) {
                        ...
                        JOptionPane.showMessageDialog(null, "Logged in Successfully !!");
                             ...
                             TAViewMaterials dm = new TAViewMaterials();
                        dm.setLocationRelativeTo(null);
                        dm.setVisible(true);
                        Registry r = LocateRegistry.getRegistry(1099);
                        TAMaterialsController amc = new TAMaterialsController(dm, r, ta2);
                        gui.dispose();
                        }
