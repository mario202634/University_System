...
public class Student extends UnicastRemoteObject implements user, rmi.Student {
    ...
    private MongoCollection<Document> MaterialConnec;
...

    ...
    public Student() throws RemoteException {
        ...
        MaterialConnec = database.getCollection("Material");
        gson = new Gson();
    }
...
//            System.out.println(result);
    ...
    @Override
    public ArrayList<String> getMaterialsByCourseName(String CourseName) throws RemoteException {
        Document docs = CourseCollection.find(Filters.eq("CourseTitle", CourseName)).first();
        String jsonResult = docs.toJson();
        Course cour = gson.fromJson(jsonResult, Course.class);
        ArrayList<String> result = new ArrayList();
        ArrayList<Document> materials = MaterialConnec.find(Filters.eq("CourseID", cour.getCourseID())).into(new ArrayList<>());
        ArrayList<String> courses = new ArrayList<>();
        for (int i = 0; i < materials.size(); i++) {
            String jsonResults = materials.get(i).toJson();
            Material mat = gson.fromJson(jsonResults, Material.class);
            if (mat.isMaterialVisibility() == true) {
                result.add(mat.getMaterialTitle());
            }
        }
        return result;
    }
